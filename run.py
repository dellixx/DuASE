...
def parse_args(args=None):
    ...
    parser.add_argument('-tcr', '--triple_complex_relation', action='store_true')
    ...
    parser.add_argument('-n2', '--norm2', action='store_true')
...
def main(args):
    args.save_path = 'log/%s/%s/%s-%s-%s/%s'%(args.model, args.dataset, args.hidden_dim, args.gamma, args.randomSeed, time.time()) if args.save_path == None else args.save_path
    ...
    kge_model = KGEModel(
        ...
        triple_complex_relation=args.triple_complex_relation,
        norm2 = args.norm2
